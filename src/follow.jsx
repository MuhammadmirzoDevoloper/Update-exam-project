...
const follow = () => {
  return (
    <div className="container text-white  p-11">
      <div className="  ">
      ...
      <div className="img">
        <h1 className='text-4xl py-7'>Compare our plans and find the right one for you</h1>
        ...
        <img className='py-11' src="./src/assets/img/Sub Container.png" alt="" />
      </div>
    </div>
  );
}   
